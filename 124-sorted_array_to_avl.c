 ...
 *     * @size: element array
 *      *
 *       * Return: A pointer  root node of AVL tree, NULL on failure.
 */
avl_t *sorted_array_to_avl(int *array, size_t size)
{
...
/**
 *  * aux_sort - Create tree half element of the array.
 *   *
 *    * @parent: Parent node.
 *     * @array: Sorted array.
 *      * @begin: Position array starts.
 *       * @last: Position array ends.
 *        *
 *         * Return: Tree to be created.
 */
avl_t *aux_sort(avl_t *parent, int *array, int begin, int last)
{
	avl_t *root;
